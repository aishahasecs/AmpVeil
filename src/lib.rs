...
#[derive(Debug)]
pub struct AmpVeilProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AmpVeilProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AmpVeil processing");
    
    let mut processor = AmpVeilProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AmpVeilProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AmpVeilProcessor::new(false);
